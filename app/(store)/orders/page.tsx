...
async function Orders() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white p-4">
      <div className="bg-yellow-50 p-4 sm:p-8 rounded-xl shadow-lg w-full max-w-4xl">
        <h1 className="text-4xl font-bold text-gray-700 tracking-light mb-8">
          My Orders
        </h1>
            ...
            {orders.map((order) => (
              ...
              >
                <div className="p-4 sm:p-6 border-b border-gray-200">
                  <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center mb-4">
                    <div>
                      ...
                      <p className="font-mono font-bold text-sm text-blue-500 break-all">
                        {order.orderNumber}
                      </p>
                    </div>
                ...
                <div className="px-4 py-3 sm:px-6 sm:py-4">
                  <p className="text-sm font-semi-bold text-gray-700 mb-3 sm:mb-4">
                    Order Items
                  </p>
